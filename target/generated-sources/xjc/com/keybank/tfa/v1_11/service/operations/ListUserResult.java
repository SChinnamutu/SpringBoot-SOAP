    ...
    extends Result
{
	...
	public String toString() {
		return "ListUserResult [statusInfo=" + statusInfo + ", cixNumber=" + cixNumber + ", firstName=" + firstName
				+ ", lastName=" + lastName + ", tamuid=" + tamuid + ", delegationGroup=" + delegationGroup
				+ ", accountValid=" + accountValid + ", passwordValid=" + passwordValid + ", gsoUser=" + gsoUser
				+ ", fraudAlert=" + fraudAlert + ", userPartyId=" + userPartyId + "]";
	}
