...
/**
 * The response object for the Phone Reset Password Call operation.
 * Properties:
 ...
 * token must be passed to the Phone Reset Password Poll operation. This token
 * will always be a string, but it's content and size may change at any time.
 * PIN: The users PIN. This value will only be returned if you choose to have the
 * user enter their PIN in to the phone, in which case you should display this
 * PIN to the user on screen.
 * 
 * <p>Java class for PhoneResetPasswordCallResult complex type.
 * 
 * <p>The following schema fragment specifies the expected         content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PhoneResetPasswordCallResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PhoneResetPasswordCallResult", propOrder = {
    "statusInfo",
    "transactionToken",
    "pin"
})
public class PhoneResetPasswordCallResult
    extends Result
{
