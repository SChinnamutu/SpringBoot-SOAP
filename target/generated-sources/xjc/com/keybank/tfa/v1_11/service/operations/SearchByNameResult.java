...
/**
 * The response object for the Search By Name operation.
 * Properties:
 * StatusInfo: Standard operation result status object.
 * UserList: A list of user IDs where the first and last names match (partial or
 * whole) the input values.
 * 
 * <p>Java class for SearchByNameResult complex type.
 * 
 * <p>The following schema fragment specifies the expected         content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SearchByNameResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SearchByNameResult", propOrder = {
    "statusInfo",
    "userList"
})
